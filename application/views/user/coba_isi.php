                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    <form action="http://localhost/surveyumkm/index.php/user/LaporanKeuangan/tambah_lembaga" method="post" class="addcourse" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="nama_umkm" class="form-control" required="">
                                                                ...
                                                                <div class="form-group">
                                                                  ...
                                                                  <div class="form-control">
                                                                    <?php foreach ($data4 as $key) { ?>
                                                                        <input type="radio" name="transaksi" class="transaksi" value="<?= $key->id ?>"><?= $key->name ?>
                                                                        <?php } ?>
                                                                </div>

                                                                <div class="form-group" id="transaksi_sub">
                                                                </div>

                                                                <div class="form-group" id="transaksi_sub_sub"></div>

                                                                <div class="form-group" id="transaksi_sub_sub_sub"></div>

                                                                <div class="form-group" id="transaksi_sub_sub_sub_sub"></div>
                                                                <div class="form-group">
                                                ...
                                                <form action="http://localhost/surveyumkm/index.php/user/LaporanKeuangan/tambah_pemasaran" method="post">
                                                    <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" name="nominal" placeholder="contoh : Rp. 1.000.000"> 
                                                                </div>
                                                                <div class="form-group">
