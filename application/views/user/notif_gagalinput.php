...
<body>
    <!-- Start Welcome area -->
        ...
        <strong>Transaksi Gagal !</strong> Anda hanya bisa input sekali setiap bulan.
        Klik untuk <a href="http://localhost/surveyumkm/index.php/user/RiwayatLaporan/index"> Edit data</a>
        </div>
