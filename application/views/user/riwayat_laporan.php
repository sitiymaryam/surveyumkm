                                                            ...
                                                            <div class="datatable-dashv1-list custom-datatable-overright">
                                                                <table id="table" data-toggle="table">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><a href="<?php echo base_url("index.php/user/LaporanKeuangan/detail_produksi/");echo ($key->id); ?>" type="button" class="btn btn-custon-rounded-four btn-primary" style="color: white">Detail</a></td>
                                                                        <td>
                                                                            <?php $tanggal = date('Y-m-d');
                                                                            if ( $tanggal > $periode_awal && $tanggal < $periode_akhir ) {?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><a href="<?php echo base_url("index.php/user/LaporanKeuangan/detail_keuangan/");echo ($key->id); ?>" type="button" class="btn btn-custon-rounded-four btn-primary" style="color: white">Detail</a></td>
                                                                        <td>
                                                                            <?php $tanggal = date('Y-m-d');
                                                                            if ( $tanggal > $periode_awal && $tanggal < $periode_akhir ) {?>
