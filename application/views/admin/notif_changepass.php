...
<head>
    ...
    <title>Sistem Laporan Survei UMKM</title>
    ...
    <!-- style CSS
    ============================================ -->
    <link rel="stylesheet" href="<?php echo base_url();?>asset3/css/alerts.css">
    <!-- style CSS
    ============================================ -->
...
<body>
    <div style="margin-top: 5px" class="alert alert-info">
        ...
        <strong>Ganti Password Berhasil !</strong> Klik untuk <a href="http://localhost/surveyumkm/admin/Login/index">Login</a> 
    </div>
</body>
