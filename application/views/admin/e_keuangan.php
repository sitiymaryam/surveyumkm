<body>
    ...
    <div  style=" width: 98%; text-align: left; padding :10px">
     ...
     <div class="alert alert-info" style=" width: 98%; text-align: right; padding :2px">
        <a href="http://localhost/surveyumkm/user/LaporanKeuangan/lihat_laporan" type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    <form action="http://localhost/surveyumkm/index.php/admin/DataLaporan/update_keuangan" method="post" class="addcourse" id="demo1-upload">
                                                        <div class="row">
